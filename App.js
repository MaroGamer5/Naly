  ...
  return (
    ...
    <>    
      ...
      <div className='socials' id='socials'>
        ...
        <a href='https://www.wattpad.com/user/EleanoraNaly' target='_blank' className='insta'><img src={insta} alt='insta'></img></a>
        <a href='https://www.wattpad.com/user/EleanoraNaly' target='_blank' className='facebook'><img src={facebook} alt='facebook'></img></a>
